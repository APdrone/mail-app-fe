...
import { ChangeComposed, ChangeMailSent } from "../store/UserSlice";
...
const Sidebar = () => {
  ...
  return (
    <div className="basis-1/12 m-3">
      <div className="mb-3">
        <div className="flex gap-3 shadow-lg shadow-slate-300 w-32 h-auto p-3  rounded-lg z-1">
          <svg
      ...
      <ul className="flex flex-col gap-3 cursor-pointer">
        <li className="flex gap-3 cursor-pointer" onClick={handleInbox}>
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
